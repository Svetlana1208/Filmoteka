...
import { watchedMovies, queueMovies } from "./authorization";
            ...
            data.forEach((movie) => {
                if (movie.id === movieIndex) {
                        ...
                        function addToWatched() {
                            setDoc(doc(watchedMovies, `${movie.id}`), movie);
                            onCloseModal();    
                        }

                        function addToQueue() {
                            setDoc(doc(queueMovies, `${movie.id}`), movie);
                            onCloseModal();
                        }
